...
//    }     
    ...
    public static void main(String[] args) {     
        ...
        String key = "RMgtxJl85HJkjO3sbHwXwd8aiIUWIoYi";
        String afStr = Authcode2.authcodeEncode(test, key);     
        System.out.println("--------encode:" + afStr);     
        String deStr = Authcode2.authcodeDecode(afStr, key);     
        System.out.println("--------decode:" + deStr);   
          
        String deStr1 = Authcode2.authcodeDecode("HeGUeCVbBYBdVwK9aSGwi0b1B2sfdClZSpjR", "czyb");     
